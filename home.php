    ...
    <section class="probootstrap-cover overflow-hidden relative"  style="background-image: url('assets/images/bg_1.jpg');" data-stellar-background-ratio="0.5"  id="section-home">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md">
            <h2 class="heading mb-2 display-4 font-light probootstrap-animate">Plan Your Travel With Confidence</h2>
          ...
          <div class="col-md probootstrap-animate">
            <form action="mybooking.php" method="POST" class="probootstrap-form">
              <div class="form-group">
                  ...
                  <div class="col-md">
                    <div class="form-group">
                      ...
                      <label for="id_label_single" style="width: 100%;">
                        <select name="from" class="js-example-basic-single js-states form-control" id="id_label_single" style="width: 100%;">
                  ...
                  <div class="col-md">
                    <div class="form-group">
                      ...
                      <div class="probootstrap-date-wrap">
                        ...
                        <input name="dep" type="text" id="probootstrap-date-departure" class="form-control" placeholder="">
                      </div>
                    </div>
                  </div>
                  <div class="col-md">
                   <div class="form-group">
                      <label for="id_label_single2">No of Person</label>
                      <div class="probootstrap_select-wrap">
                        <label for="id_label_single2" style="width: 100%;">
                        <select name="no" class="js-example-basic-single js-states form-control" id="id_label_single2" style="width: 100%;">
                ...
                <div class="row">
                  ...
                  <div class="col-md">
                    <input type="submit" name="book" value="Submit" class="btn btn-primary btn-block">
                  </div>
                </div>
              </div>
            </form>
